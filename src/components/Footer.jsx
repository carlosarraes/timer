  ...
  render() {
    return (
      <footer className="flex justify-center items-center text-xs text-center mt-16">
        <div>
          <a href="https://carlosarraes.github.io/" target="_blank">
            <button
              id="devfolio"
              className="space-x-1 border p-2 rounded-l-md opacity-80 bg-gray-50 hover:opacity-100 duration-200"
            >
              <svg
              ...
              >
                ...
                ></path></svg><span>carlos arraes</span>
            </button>
          </a>
        </div>
        <div>
          <a href="https://github.com/carlosarraes/timer/" target="_blank">
            ...
            >
              ...
              >
                ...
                ></path></svg><span className="">Código</span>
            </button>
          </a>
        </div>
      </footer>
